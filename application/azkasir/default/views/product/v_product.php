<form class="form-horizontal az-form" id="form" name="form" method="post">
	...
	<div class="form-group">
        <label for="" class="col-sm-2 control-label"><?php echo azlang('Buying Price');?> *</label>
        <div class="col-sm-4">
            <input type='text' class='form-control txt-right format-number' name='buy_price' id='buy_price' maxlength="15"/>
        </div>
    </div>
    <div class="form-group">
        <label for="" class="col-sm-2 control-label"><?php echo azlang('Selling Price');?> *</label>
        <div class="col-sm-4">
