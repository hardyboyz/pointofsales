...
class Product extends CI_Controller {
	...
	public function index(){
		...
		$sf_price = az_add_filter_text('f_'.$this->encrypt->encode('product.buy_price'));
	...
	public function edit() {
		...
		$this->db->select("product.id".$this->table.", product.idproduct_unit, idproduct_category, barcode, product.name, product.description, buy_price, price, stock");
	...
	public function save(){
		...
		$this->form_validation->set_rules('buy_price', azlang('Price'), 'required|trim|max_length[15]');
		...
		$str_buy_price = azarr($data_post, "buy_price");
		$str_buy_price = str_replace(".", "", $str_buy_price);
